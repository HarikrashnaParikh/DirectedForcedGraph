...
export class AppComponent {
  ...
  restart() {
    ...
    g.append('svg:circle')
      ...
      .on('mousedown', (d) => {
        ...
        console.log("node selected : id = " + this.selectedNode);
        this.isChild(this.selectedNode);
        this.selectedLink = null;
        
        // function handleNodeSelection(event : Event){
        //   this.selectedNode = (this.mousedownNode === this.selectedNode) ? null : this.mousedownNode;
        //   console.log("node is selected");
        // }

        // const container = document.getElementById("graphContainer");
        // container.addEventListener('click',handleNodeSelection);
  ...
  //   const node = { id: ++this.lastNodeId, reflexive: false, children: 0,x: point[0], y: point[1] };
